...
{
    public MessageData message; //ScriptableObjectであるクラスクラス
    ...
    void Update()
    {
        ...
        {
            StartConversation();  //トーク開始のメソッド発動
        }
    }
    ...
    IEnumerator TalkProcess()
    {
        ...
        for (int i = 0; i < message.msgArray.Length; i++)
        {
            ...
            //yield return new WaitForSeconds(0.1f);  <- ゲームスピード0でコルーチンも一緒に止まる
            yield return new WaitForSecondsRealtime(0.1f);

            //E kayが押されるまで「何もしない」を繰り返す
